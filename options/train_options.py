...
def get_parser():
    ...
    parser.add_argument('--mode', type=list, default=['training'], help='Running training or evaluation.')#['training','evaluation']
    ...
    parser.add_argument('--light_estimation', type=bool, default=False, help="whether to estimate lighting.")
    ...
    parser.add_argument('--lambda_vert_3d', type=float, default=100)
    ...
    parser.add_argument('--controlled_exp', type=bool, default=False, help='Use subset of datasets so that final dataset size is constant.')#Check
    ...
    parser.add_argument('--base_out_path', type=str, default='/home/outputs/freihand/SSL/debug', help='Base directory to save the outputs. Will automatically create these subdirs there: pic, model, obj, json.')
    parser.add_argument('--image_size', type=int, default=224, help='by default 224.')#224

    parser.add_argument('--is_write_tb', type=bool, default=False, help='Whether using TensorBoard. By default: false.')
    parser.add_argument('--writer_topic', type=str, default='/runs/debug/')

    parser.add_argument('--config_json', type=str, default="config/FreiHAND/evaluation.json") # full_rhd_freihand
